...
class Canvas extends React.Component<CanvasProps, IState> {
    ...
    render() {
        ...
        return (
            <div
                ref={this.container}
                id={id}
                className={this.props.orientation === 'LANDSCAPE' ? 'LayoutEditor-canvas' : 'LayoutEditor-canvas-portrait'}
                // style={{ width: '100%', height: '100%', ...style }}
            >
                <canvas className='canvas-Info' id={`canvas_${id}`} />
            </div>
            // <canvas id={`canvas_${id}`} className='LayoutEditor-canvas'/>
        );
    }
}
