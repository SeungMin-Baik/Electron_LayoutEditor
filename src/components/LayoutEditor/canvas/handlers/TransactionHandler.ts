                ...
                enlivenObjects.forEach(obj => {
                    ...
                    if (obj.superType === 'node') {
                        ...
                        this.handler.linkHandler.create({
                            type: 'curvedLink',
                            fromNodeId: link.fromNode.id ? link.fromNode.id : null,
                            fromPortId: link.fromPort.id ? link.fromPort.id : null,
                            toNodeId: link.toNode.id ? link.toNode.id : null,
                            toPortId: link.toPort.id ? link.toPort.id : null,
                        });
                    } else {
                        this.handler.canvas.insertAt(obj, targetIndex, false);
                    }
